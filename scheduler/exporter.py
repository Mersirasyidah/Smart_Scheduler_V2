...
class ScheduleExporter:
    ...
    def generate_excel(self):
        """Membuat file Excel dalam bentuk byte stream agar bisa langsung diunduh lewat Streamlit"""
        output = io.BytesIO()
    ...
    def _make_grid_view(self):
        ...
        # Gabungkan Hari dan Jam menjadi penunjuk baris tunggal
        ...
        # Lakukan pivot table agar Kelas menjadi kolom, dan Waktu menjadi baris
        try:
            grid = df_temp.pivot(index="Waktu", columns="Kelas", values="Detail")
            # Urutkan index berdasarkan struktur Hari/Jam default
            return grid.fillna("-")
        except:
            return df_temp
